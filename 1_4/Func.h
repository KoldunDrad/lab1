...
void menu(T& obj, string s) {
	...
	while (flag) {
		...
		system("cls");
		switch (button) {
		case 1: cout << "На какое место вставить новый элемент: "; cin >> id; obj.push(id);
			system("pause"); break;
		case 2: obj.print(); cout << "Какой элемент удалить: "; cin >> id; obj.del(id); system("pause");
			break;
		case 3: obj.print(); system("pause"); break;
		case 4: obj.print(); cout << "Какой элемент изменить: "; cin >> id; obj.record(id);
			system("pause"); break;
